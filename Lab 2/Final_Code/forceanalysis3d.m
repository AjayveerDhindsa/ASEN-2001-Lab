function [barforces,reacforces]=forceanalysis3d(joints,connectivity,reacjoints,reacvecs)
...
numloads  = size(joints,1);
density = 0.001214;
mass_joint = 0.00836;
%mass_joint = 0.01843065;
%density = 0.04779527554;

%%%%%%%%%%
loadjoints=[];
for i=1:numjoints
    loadjoints = [loadjoints i];
end
loadvecs = zeros(numjoints,3);
loadvecs(:,3)=weight(density,joints,connectivity,mass_joint);
